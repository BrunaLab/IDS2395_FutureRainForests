...
kable(assignments,
  ...
  row_spec(0,hline_after = T, bold=T) %>% 
...
**Note: The reading list for each session is subject to change.** For the up-to-date list of materials to read or watch in advance of each class session please refer to the course Canvas page.
...
## VII. General Education and Quest Objectives & SLOs
<!-- \vspace{0.3cm}  -->
